    ...
    <div class="drag-center">
      <div class="center-top">
        ...
        <a
          ...
          href="#"
          target="_blank"
          >设计器基于框架mesform、mestable、mesupload、mesbox定制开发</a
        >
      </div>
      <div>
        <el-alert
        ...
        >
          <div>
            1、表单设计器基于draggable开发,为本框架自定义页面功能的补充
          </div>
          <div>
  ...
  >
    <template #content>
      <el-alert title="关于table配置" type="info" :closable="false" show-icon>
        此处table是对框架mestable基本操作的配置,如果需要事件触发、数据加载等更多功能，请在生成后的代码添加需要的功能，完整配置见文档<a
          href="#"
...
import MesWangEditor from "@/components/editor/MesWangEditor.vue";
import MesUpload from "./../MesUpload";
import MesTable from "./../MesTable";
import MesBox from "./../MesBox";
import MesFormPreview from "./MesFormPreview";
...
export default {
  ...
  components: {
    ...
    "mes-upload": MesUpload,
    "mes-wang-editor": MesWangEditor,
    "mes-table": MesTable,
    "mes-box": MesBox,
    preview: MesFormPreview,
  },
  data() {
    return {
      options:{},
