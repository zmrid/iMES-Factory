...
{
    [Entity(TableCnName = "点检保养项目",TableName = "Equip_SpotMaintenance",DBServer = "SysDbContext")]
    public partial class Equip_SpotMaintenance:SysEntity
    {
        /// <summary>
       ///点检保养项目主键
       /// </summary>
       [Key]
       [Display(Name ="点检保养项目主键")]
