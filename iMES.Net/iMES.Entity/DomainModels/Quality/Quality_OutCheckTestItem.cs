...
{
    [Entity(TableCnName = "出货检验单-检验项",TableName = "Quality_OutCheckTestItem",DBServer = "SysDbContext")]
    public partial class Quality_OutCheckTestItem:SysEntity
    {
        /// <summary>
       ///出货检验单检测项主键
       /// </summary>
       [Key]
       [Display(Name ="出货检验单检测项主键")]
       [Column(TypeName="int")]
       [Editable(true)]
       [Required(AllowEmptyStrings=false)]
       public int OutCheckTestItemId { get; set; }

       /// <summary>
       ///出货检验单主键
       /// </summary>
       [Display(Name ="出货检验单主键")]
       [Column(TypeName="int")]
       [Editable(true)]
       [Required(AllowEmptyStrings=false)]
