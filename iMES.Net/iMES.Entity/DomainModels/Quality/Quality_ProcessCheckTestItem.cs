...
{
    [Entity(TableCnName = "过程检验单-检验项",TableName = "Quality_ProcessCheckTestItem",DBServer = "SysDbContext")]
    public partial class Quality_ProcessCheckTestItem:SysEntity
    {
        /// <summary>
       ///过程检验单检测项主键
       /// </summary>
       [Key]
       [Display(Name ="过程检验单检测项主键")]
       [Column(TypeName="int")]
       [Editable(true)]
       [Required(AllowEmptyStrings=false)]
       public int ProcessCheckTestItemId { get; set; }
